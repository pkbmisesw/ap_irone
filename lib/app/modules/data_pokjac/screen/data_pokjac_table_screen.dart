...
import '../../../services/data_services/data_pokjac_services.dart';
import '../model/data_pokjac.dart';
import '../model/data_pokjac_model.dart';

class TableDataPokjacScreen extends StatefulWidget {
  const TableDataPokjacScreen({super.key});

  @override
  _TableDataPokjacScreenState createState() => _TableDataPokjacScreenState();
}

class _TableDataPokjacScreenState extends State<TableDataPokjacScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjacModel> dataRekap = await dataServices.fetchTableData();
