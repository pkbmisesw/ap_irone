...
import 'package:silahan_kawan/app/modules/data_pokjac/model/data_pokjac_chart_model.dart';
...
class DataPokjacPieScreen extends StatefulWidget {
  const DataPokjacPieScreen({super.key});

  @override
  State<DataPokjacPieScreen> createState() => _DataPokjacPieScreenState();
}

class _DataPokjacPieScreenState extends State<DataPokjacPieScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjacModel> newData = await dataServices.fetchDataPokjaChartnew(
        'data_pokjac',
      );
      setState(() {
        chartData = newData;
