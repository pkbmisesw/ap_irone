...
class DataPokjacLineScreen extends StatefulWidget {
  @override
  _DataPokjacLineScreenState createState() => _DataPokjacLineScreenState();
}

class _DataPokjacLineScreenState extends State<DataPokjacLineScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjacModel> newData =
          await dataServices.fetchDataPokjaChartnew('data_pokjac');
