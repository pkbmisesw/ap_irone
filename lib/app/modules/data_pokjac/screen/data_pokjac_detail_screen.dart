...
class DataPokjacDetailScreen extends StatefulWidget {
  DataPokjacDetailScreen({super.key, required this.data});

  final DataPokjacModel data;

  @override
  State<DataPokjacDetailScreen> createState() => _DataPokjacDetailScreenState();
}

class _DataPokjacDetailScreenState extends State<DataPokjacDetailScreen> {
  final controller = Get.put(DataPokjacController());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjacController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
