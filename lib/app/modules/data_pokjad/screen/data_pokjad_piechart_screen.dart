...
class DataPokjadPieScreen extends StatefulWidget {
  const DataPokjadPieScreen({super.key});

  @override
  State<DataPokjadPieScreen> createState() => _DataPokjadPieScreenState();
}

class _DataPokjadPieScreenState extends State<DataPokjadPieScreen> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    try {
      List<DataPokjadModel> newData = await dataServices.fetchDataPokjaChartnew(
        'data_pokjad',
      );
