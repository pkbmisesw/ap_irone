...
import '../controller/data_pokjad_controller.dart';
import '../model/data_pokjad_model.dart';

class DataPokjadDetailScreen extends StatefulWidget {
  DataPokjadDetailScreen({super.key, required this.data});

  final DataPokjadModel data;

  @override
  State<DataPokjadDetailScreen> createState() => _DataPokjadDetailScreenState();
}

class _DataPokjadDetailScreenState extends State<DataPokjadDetailScreen> {
  final controller = Get.put(DataPokjadController());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjadController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
