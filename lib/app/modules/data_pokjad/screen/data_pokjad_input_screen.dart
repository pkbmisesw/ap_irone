...
import '../controller/data_pokjad_input_controller.dart';
import '../model/data_pokjad_model.dart';

class DataPokjadInputScreen extends StatefulWidget {
  DataPokjadInputScreen({
    super.key,
  });

  @override
  State<DataPokjadInputScreen> createState() => _DataPokjadInputScreenState();
}

class _DataPokjadInputScreenState extends State<DataPokjadInputScreen> {
  final controller = Get.put(DataPokjadInputController());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjadInputController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
    ...
    return Column(
      children: List.generate(
        ...
        (index) => WidgetForm(
          ...
          errorText: '',
          icon: Remix.pencil_line,
          inputFormatters: [controller.keyboardTypes[index + 25]],
        ),
      ),
    );
  }
