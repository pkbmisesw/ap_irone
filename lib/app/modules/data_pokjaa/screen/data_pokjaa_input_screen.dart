...
import '../controller/data_pokjaa_input_controller.dart';

class DataPokjaInputScreen extends StatefulWidget {
  DataPokjaInputScreen({
    super.key,
  });

  @override
  State<DataPokjaInputScreen> createState() => _DataPokjaInputScreenState();
}

class _DataPokjaInputScreenState extends State<DataPokjaInputScreen> {
  final controller = Get.put(DataPokjaInputController());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjaInputController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
    ...
    return Column(
      children: List.generate(
        ...
        (index) => WidgetForm(
          ...
          errorText: '',
          icon: Remix.pencil_line,
          inputFormatters: [controller.keyboardTypes[index + 16]],
        ),
      ),
    );
  }
