...
class TableDataPokjaaScreen extends StatefulWidget {
  const TableDataPokjaaScreen({super.key});

  @override
  _TableDataPokjaaScreenState createState() => _TableDataPokjaaScreenState();
}

class _TableDataPokjaaScreenState extends State<TableDataPokjaaScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjaModel> dataRekap =
          await dataServices.fetchTableData('data_pokjaa');
