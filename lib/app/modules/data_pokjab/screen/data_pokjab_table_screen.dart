...
import '../../../services/data_services/data_pokjab_services.dart';
import '../models/data_pokjab.dart';
import '../models/data_pokjab_model.dart';

class TableDataPokjabScreen extends StatefulWidget {
  const TableDataPokjabScreen({super.key});

  @override
  _TableDataPokjabScreenState createState() => _TableDataPokjabScreenState();
}

class _TableDataPokjabScreenState extends State<TableDataPokjabScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjabModel> dataRekap = await dataServices.fetchTableData();
