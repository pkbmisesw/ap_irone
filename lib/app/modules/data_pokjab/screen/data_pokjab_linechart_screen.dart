...
class DataPokjabLineScreen extends StatefulWidget {
  @override
  _DataPokjabLineScreenState createState() => _DataPokjabLineScreenState();
}

class _DataPokjabLineScreenState extends State<DataPokjabLineScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjabModel> newData =
          await dataServices.fetchDataPokjaChartnew('data_pokjab');
