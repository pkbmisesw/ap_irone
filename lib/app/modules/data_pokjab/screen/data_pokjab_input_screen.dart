...
import '../controller/data_pokjab_input_controller.dart';

class DataPokjabInputScreen extends StatefulWidget {
  DataPokjabInputScreen({
    super.key,
  });

  @override
  State<DataPokjabInputScreen> createState() => _DataPokjabInputScreenState();
}

class _DataPokjabInputScreenState extends State<DataPokjabInputScreen> {
  final controller = Get.put(DataPokjabInputController());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjabInputController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
