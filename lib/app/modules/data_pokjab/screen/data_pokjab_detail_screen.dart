...
import '../controller/data_pokjab_controller.dart';
import '../models/data_pokjab_model.dart';

class DataPokjabDetailScreen extends StatefulWidget {
  DataPokjabDetailScreen({super.key, required this.data});

  final DataPokjabModel data;

  @override
  State<DataPokjabDetailScreen> createState() => _DataPokjabDetailScreenState();
}

class _DataPokjabDetailScreenState extends State<DataPokjabDetailScreen> {
  final controller = Get.put(DataPokjabController());
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Data Pokja 2 - ${widget.data.namaLing}',
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataPokjabController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
...
class _StepperKeluarga extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(
        controller.datas.length - 25, // Hanya indeks 20 sampai 44 ini kn 24 14
        (index) => WidgetForm(
          hint: 'Masukkan ${controller.datas[index + 25]}',
          tittle: controller.datas[index + 25],
          controller: controller.editingControllers[index + 25],
          errorText: '',
          icon: Remix.pencil_line,
        ),
      ),
