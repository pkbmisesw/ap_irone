...
class DataPokjabPieScreen extends StatefulWidget {
  const DataPokjabPieScreen({super.key});

  @override
  State<DataPokjabPieScreen> createState() => _DataPokjabPieScreenState();
}

class _DataPokjabPieScreenState extends State<DataPokjabPieScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjabModel> newData = await dataServices.fetchDataPokjaChartnew(
        'data_pokjab',
      );
