...
import 'package:irone/app/modules/data_pokjab/screen/data_pokjab_detail_screen.dart';
import 'package:irone/theme.dart';
import 'package:remixicon/remixicon.dart';
import 'package:get/get.dart';

import '../../../data_pokjab/models/data_pokjab_model.dart';
import '../controller/data_pokjab_services.dart';
import 'data_pokjab_detail_screen.dart';

class AdminKecDataPokjabListScreen extends StatefulWidget {
  const AdminKecDataPokjabListScreen({super.key});

  @override
  State<AdminKecDataPokjabListScreen> createState() =>
      _AdminKecDataPokjabListScreenState();
}

class _AdminKecDataPokjabListScreenState
    extends State<AdminKecDataPokjabListScreen> {
  final AdminKecDataPokjabServices services = AdminKecDataPokjabServices();
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    function1: () {
                                      Get.to(
                                          () => AdminKecDataPokjabDetailScreen(
                    ...
                    fuctionMore: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            function1: () {
                              Get.to(() => AdminKecDataPokjabDetailScreen(
                                    data: data,
                                  ));
                            },
                            function2: () {},
