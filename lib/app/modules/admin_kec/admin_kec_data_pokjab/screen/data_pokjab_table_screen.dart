...
class AdminKecTableDataPokjabScreen extends StatefulWidget {
  const AdminKecTableDataPokjabScreen({super.key});

  @override
  _AdminKecTableDataPokjabScreenState createState() =>
      _AdminKecTableDataPokjabScreenState();
}

class _AdminKecTableDataPokjabScreenState
    extends State<AdminKecTableDataPokjabScreen> {
