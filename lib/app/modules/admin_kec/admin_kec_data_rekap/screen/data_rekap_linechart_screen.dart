...
class AdminKecDataRekapLineScreen extends StatefulWidget {
  @override
  _AdminKecDataRekapLineScreenState createState() =>
      _AdminKecDataRekapLineScreenState();
}

class _AdminKecDataRekapLineScreenState
    extends State<AdminKecDataRekapLineScreen> {
  ...
  void getData() async {
    try {
      List<ModelChartApi> newData =
          await dataServices.fetchPieChart(useIdKec: true);
