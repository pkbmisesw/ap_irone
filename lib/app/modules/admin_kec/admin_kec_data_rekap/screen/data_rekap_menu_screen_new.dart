...
import 'data_rekap_barchart_screen.dart';
import 'data_rekap_linechart_screen.dart';
import 'data_rekap_piechart_screen.dart';
import 'data_rekap_screen.dart';
import 'data_rekap_table_screen.dart';

class AdminKecDataRekapHome extends StatefulWidget {
  AdminKecDataRekapHome({super.key});

  @override
  State<AdminKecDataRekapHome> createState() => _AdminKecDataRekapHomeState();
}

class _AdminKecDataRekapHomeState extends State<AdminKecDataRekapHome> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBarUniversal(title: 'Data Rekap - admin : ${_loadName()}'),
        body: Padding(
              ...
              Expanded(
                child: GridView(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        Get.to(() => AdminKecDataRekapScreen());
                      },
                      child: ButtonData(
                    ...
                    InkWell(
                      onTap: () {
                        Get.to(() => AdminKecDataRekapPieScreen());
                      },
                      child: ButtonData(
                    ...
                    // InkWell(
                    //   onTap: () {
                    //     Get.to(() => AdminKecDataRekapBarScreen());
                    //   },
                    //   child: ButtonData(
                    ...
                    // InkWell(
                    //   onTap: () {
                    //     Get.to(() => AdminKecDataRekapLineScreen());
                    //   },
                    //   child: ButtonData(
