...
class AdminKecDataRekapPieScreen extends StatefulWidget {
  ...
  @override
  State<AdminKecDataRekapPieScreen> createState() =>
      _AdminKecDataRekapPieScreenState();
}

class _AdminKecDataRekapPieScreenState
    extends State<AdminKecDataRekapPieScreen> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    try {
      List<DataRekapModels> newData =
          await dataServices.fetchPiePerbandinganChart(useIdKec: true);
