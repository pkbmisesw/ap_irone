...
class AdminKecDataUmumPieScreen extends StatefulWidget {
  const AdminKecDataUmumPieScreen({super.key});

  @override
  State<AdminKecDataUmumPieScreen> createState() =>
      _AdminKecDataUmumPieScreenState();
}

class _AdminKecDataUmumPieScreenState extends State<AdminKecDataUmumPieScreen> {
  ...
  void getData() async {
    try {
      List<DataUmumModel> newData =
          await dataServices.fetchDataUmumPiePerbandinganChart(useIdKec: true);
