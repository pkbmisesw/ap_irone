...
import 'data_umum_detail_screen.dart';

// *STANDART CODE*

class AdminKecDataUmumListScreen extends StatefulWidget {
  const AdminKecDataUmumListScreen({super.key});

  @override
  State<AdminKecDataUmumListScreen> createState() =>
      _AdminKecDataUmumListScreenState();
}

class _AdminKecDataUmumListScreenState
    extends State<AdminKecDataUmumListScreen> {
  final AdminKecDataUmumServicesX services = AdminKecDataUmumServicesX();
