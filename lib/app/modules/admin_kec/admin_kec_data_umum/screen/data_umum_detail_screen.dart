...
class AdminKecDataDetailsUmumScreen extends StatefulWidget {
  AdminKecDataDetailsUmumScreen({super.key, required this.data});

  final DataUmumModel data;

  @override
  State<AdminKecDataDetailsUmumScreen> createState() =>
      _AdminKecDataDetailsUmumScreenState();
}

class _AdminKecDataDetailsUmumScreenState
    extends State<AdminKecDataDetailsUmumScreen> {
  final controller = Get.put(AdminKecDataUmumServices());
...
class _StepperReview extends StatelessWidget {
  ...
  final controller = Get.find<AdminKecDataUmumServices>();
