...
class AdminKecDataPokjadPieScreen extends StatefulWidget {
  ...
  @override
  State<AdminKecDataPokjadPieScreen> createState() =>
      _AdminKecDataPokjadPieScreenState();
}

class _AdminKecDataPokjadPieScreenState
    extends State<AdminKecDataPokjadPieScreen> {
  @override
  void initState() {
    super.initState();
    getData();
