...
import 'package:silahan_kawan/app/modules/data_pokjad/model/data_pokjad.dart';
...
class AdminKecTableDataPokjadScreen extends StatefulWidget {
  const AdminKecTableDataPokjadScreen({super.key});

  @override
  _AdminKecTableDataPokjadScreenState createState() =>
      _AdminKecTableDataPokjadScreenState();
}

class _AdminKecTableDataPokjadScreenState
    extends State<AdminKecTableDataPokjadScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjadModel> dataRekap =
          await dataServices.fetchTableData(useIdKec: true);
