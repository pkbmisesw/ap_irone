...
class AdminKecDataPokjadDetailScreen extends StatefulWidget {
  AdminKecDataPokjadDetailScreen({super.key, required this.data});

  final DataPokjadModel data;

  @override
  State<AdminKecDataPokjadDetailScreen> createState() =>
      _AdminKecDataPokjadDetailScreenState();
}

class _AdminKecDataPokjadDetailScreenState
    extends State<AdminKecDataPokjadDetailScreen> {
  final controller = Get.put(AdminKecDataPokjadController());
...
class _StepperReview extends StatelessWidget {
  ...
  final controller = Get.find<AdminKecDataPokjadController>();
