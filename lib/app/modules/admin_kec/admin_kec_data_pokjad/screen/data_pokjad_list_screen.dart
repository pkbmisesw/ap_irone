...
import '../controller/data_pokjad_services.dart';
import 'data_pokjad_detail_screen.dart';

class AdminKecDataPokjadListScreen extends StatefulWidget {
  const AdminKecDataPokjadListScreen({super.key});

  @override
  State<AdminKecDataPokjadListScreen> createState() =>
      _AdminKecDataPokjadListScreenState();
}

class _AdminKecDataPokjadListScreenState
    extends State<AdminKecDataPokjadListScreen> {
  final AdminKecDataPokjadServices services = AdminKecDataPokjadServices();
  final RxList<DataPokjadModel> fullData = <DataPokjadModel>[].obs;

  final RxList<DataPokjadModel> dataFilter = <DataPokjadModel>[].obs;
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    function1: () {
                                      Get.to(
                                          () => AdminKecDataPokjadDetailScreen(
                    ...
                    fuctionMore: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                              function1: () {
                                Get.to(() => AdminKecDataPokjadDetailScreen(
                                      data: data,
                                    ));
                              },
                              detailData: 'Detail Data',
