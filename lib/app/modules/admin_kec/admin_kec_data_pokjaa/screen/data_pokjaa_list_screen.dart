...
import 'package:irone/app/modules/data_pokjaa/widget/data_pokja_list_widget.dart';
import 'package:irone/theme.dart';
import 'package:remixicon/remixicon.dart';
import 'package:get/get.dart';
import '../controller/data_pokjaa_services.dart';
import 'data_pokjaa_detail_screen.dart';

class AdminKecDataPokjaaListScreen extends StatefulWidget {
  const AdminKecDataPokjaaListScreen({super.key});

  @override
  State<AdminKecDataPokjaaListScreen> createState() =>
      _AdminKecDataPokjaaListScreenState();
}

class _AdminKecDataPokjaaListScreenState
    extends State<AdminKecDataPokjaaListScreen> {
  final AdminKecDataPokjaaServices services = AdminKecDataPokjaaServices();
  final RxList<DataPokjaModel> fullData = <DataPokjaModel>[].obs;

  final RxList<DataPokjaModel> dataFilter = <DataPokjaModel>[].obs;
                      ...
                      (index) {
                        if (index < services.data.length) {
                          return DataPokjaListWidget(
                            id: services.data[index].kecamatan_nama.toString(),
                            idKec:
                                services.data[index].kelurahan_nama.toString(),
                            idKel: services.data[index].idKel.toString(),
                    ...
                    fuctionMore: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            function1: () {
                              Get.to(() => DataPokjaDetailScreen(data: data));
                            },
                            function2: () {},
                            isDeleteAdd: true,
                            detailData: 'Detail Data',
