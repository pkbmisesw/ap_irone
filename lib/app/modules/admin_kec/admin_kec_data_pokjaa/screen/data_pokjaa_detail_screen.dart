...
import '../controller/data_pokjaa_controller.dart';
...
class _DataPokjaDetailScreenState extends State<DataPokjaDetailScreen> {
  final controller = Get.put(AdminKecDataKecPokjaaController());
...
class _StepperReview extends StatelessWidget {
  ...
  final controller = Get.find<AdminKecDataKecPokjaaController>();
