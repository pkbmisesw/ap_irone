...
import 'details_rekap_screen.dart';
import 'package:get/get.dart';
// *STANDART CODE*

class DataRekapScreen extends StatefulWidget {
  const DataRekapScreen({super.key});

  @override
  State<DataRekapScreen> createState() => _DataRekapScreenState();
}

class _DataRekapScreenState extends State<DataRekapScreen> {
  final DataRekapServicesX services = DataRekapServicesX();
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  _bodyValue('ID Kecamatan', '${data.idKec}'),
                                  _bodyValue('ID Kelurahan', '${data.idKel}'),
                                  _bodyValue(
