...
import 'data_rekap_input_screen.dart';

class DataRekapScreenNew extends StatefulWidget {
  DataRekapScreenNew({super.key, required this.data});

  final DataRekapModels data;

  @override
  State<DataRekapScreenNew> createState() => _DataRekapScreenNewState();
}

class _DataRekapScreenNewState extends State<DataRekapScreenNew> {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataRekapServices>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
