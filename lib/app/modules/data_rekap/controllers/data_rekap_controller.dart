...
class DataRekapServices extends GetxController {
  ...
  void updateEditingControllers(DataRekapModels data) {
    editingControllers[0].text = data.idKel.toString();
    editingControllers[1].text = data.namaLing;
    editingControllers[2].text = data.idKec.toString();
