...
import '../controller/super_admin_data_umum_services.dart';
import 'super_admin_data_detail.dart';

class SuperDataUmumListScreen extends StatefulWidget {
  const SuperDataUmumListScreen({super.key});

  @override
  State<SuperDataUmumListScreen> createState() =>
      _SuperDataUmumListScreenState();
}

class _SuperDataUmumListScreenState extends State<SuperDataUmumListScreen> {
  final DataUmumServicesSuper services = DataUmumServicesSuper();
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    isDeleteAdd: true,
                                    function1: () {
                                      Get.to(() => SuperAdminDataUmumEditScreen(
