...
import '../controller/super_admin_data_umum_controller.dart';

class SuperAdminDataUmumEditScreen extends StatefulWidget {
  SuperAdminDataUmumEditScreen({super.key, required this.data});

  final DataUmumModel data;

  @override
  State<SuperAdminDataUmumEditScreen> createState() =>
      _SuperAdminDataUmumEditScreenState();
}

class _SuperAdminDataUmumEditScreenState
    extends State<SuperAdminDataUmumEditScreen> {
  final controller = Get.put(SuperAdminDataUmumServices());
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Data Umum - ${widget.data.namaLing}',
...
class _StepperReview extends StatelessWidget {
  ...
  final controller = Get.find<SuperAdminDataUmumServices>();
