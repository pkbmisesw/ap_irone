...
class MenuUmumPieList extends StatefulWidget {
  const MenuUmumPieList({super.key});

  @override
  State<MenuUmumPieList> createState() => _MenuUmumPieListState();
}

class _MenuUmumPieListState extends State<MenuUmumPieList> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    try {
      List<DataUmumModel> newData = await _fetchDataRekapPieChart();
