...
class SuperAdminTableDataUmumScreen extends StatefulWidget {
  const SuperAdminTableDataUmumScreen({super.key});

  @override
  _SuperAdminTableDataUmumScreenState createState() =>
      _SuperAdminTableDataUmumScreenState();
}

class _SuperAdminTableDataUmumScreenState
    extends State<SuperAdminTableDataUmumScreen> {
  ...
  void getData() async {
    try {
      List<DataRekapModels> dataRekap =
          await dataServices.fetchTableDataUmum(withoutID: true);
