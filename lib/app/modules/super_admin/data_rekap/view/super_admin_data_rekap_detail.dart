...
class SuperAdminDataRekapViewScreen extends StatefulWidget {
  SuperAdminDataRekapViewScreen({super.key, required this.data});

  final DataRekapModels data;

  @override
  State<SuperAdminDataRekapViewScreen> createState() =>
      _SuperAdminDataRekapViewScreenState();
}

class _SuperAdminDataRekapViewScreenState
    extends State<SuperAdminDataRekapViewScreen> {
