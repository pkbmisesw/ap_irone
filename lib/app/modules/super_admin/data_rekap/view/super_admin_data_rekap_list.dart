...
import '../controller/super_admin_data_rekap_services.dart';
import 'super_admin_data_rekap_detail.dart';

class SuperDataRekapListScreen extends StatefulWidget {
  const SuperDataRekapListScreen({super.key});

  @override
  State<SuperDataRekapListScreen> createState() =>
      _SuperDataRekapListScreenState();
}

class _SuperDataRekapListScreenState extends State<SuperDataRekapListScreen> {
  final DataRekapServicesSuper services = DataRekapServicesSuper();
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            isDeleteAdd: true,
                            function1: () {
                              Get.to(() => SuperAdminDataRekapViewScreen(
                                    data: data,
                                  ));
                            },
                            function2: () {},
