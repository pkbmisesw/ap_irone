...
class MenuRekapPieList extends StatefulWidget {
  const MenuRekapPieList({super.key});

  @override
  State<MenuRekapPieList> createState() => _MenuRekapPieListState();
}

class _MenuRekapPieListState extends State<MenuRekapPieList> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    try {
      List<DataRekapModels> newData = await _fetchDataRekapPieChart();
  ...
  Future<List<DataRekapModels>> _fetchDataRekapPieChart() async {
    final url = '${baseUrl}data-rekap-view';
    try {
  ...
  List<String> listName = [
    ...
    'Kepala Rumah Tangga',
    'Kepala Keluarga',
    "Anggota Keluarga Total Laki-laki",
    "Anggota Keluarga Total Perempuan",
    "Balita Keluarga Total Laki-laki",
    "Balita Keluarga Total Perempuan",
  ];
                          ...
                          child: UnExpandableRecords(
                            data: SettingData(
                                ...
                                onTap: () {
                                  ...
                                  if (index == 0) {
                                    Get.to(() => SuperDataRekapPieScreen(
                                          title:
                                              'Perbandingan Total ${listName[0]} dan Total ${listName[1]}',
...
class SuperDataRekapPieScreen extends StatefulWidget {
  final String title;
  final double totalData1;
  final double totalData2;
  final List<String> name;

  const SuperDataRekapPieScreen(
      {super.key,
  ...
  @override
  _SuperDataRekapPieScreenState createState() =>
      _SuperDataRekapPieScreenState();
}

class _SuperDataRekapPieScreenState extends State<SuperDataRekapPieScreen> {
  RxBool isLoading = true.obs;
