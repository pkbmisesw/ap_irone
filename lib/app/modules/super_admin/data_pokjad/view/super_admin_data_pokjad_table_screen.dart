...
class SuperAdminTableDataPokjadScreen extends StatefulWidget {
  const SuperAdminTableDataPokjadScreen({super.key});

  @override
  _SuperAdminTableDataPokjadScreenState createState() =>
      _SuperAdminTableDataPokjadScreenState();
}

class _SuperAdminTableDataPokjadScreenState
    extends State<SuperAdminTableDataPokjadScreen> {
