...
import '../controller/super_admin_data_pokjad_services.dart';
import 'super_admin_data_pokjad_detail.dart';

class SuperDataPokjadListScreen extends StatefulWidget {
  const SuperDataPokjadListScreen({super.key});

  @override
  State<SuperDataPokjadListScreen> createState() =>
      _SuperDataPokjadListScreenState();
}

class _SuperDataPokjadListScreenState extends State<SuperDataPokjadListScreen> {
  final DataPokjadServicesSuper services = DataPokjadServicesSuper();
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    ...
                                    function1: () {
                                      Get.to(
                                          () => SuperAdminDataPokjadViewScreen(
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            isDeleteAdd: true,
                            function1: () {
                              Get.to(() => SuperAdminDataPokjadViewScreen(
                                    data: data,
                                  ));
                            },
                            function2: () {},
