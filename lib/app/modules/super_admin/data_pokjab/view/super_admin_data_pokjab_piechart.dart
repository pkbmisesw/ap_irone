...
class MenuPokjabPieList extends StatefulWidget {
  const MenuPokjabPieList({super.key});

  @override
  State<MenuPokjabPieList> createState() => _MenuPokjabPieListState();
}

class _MenuPokjabPieListState extends State<MenuPokjabPieList> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    try {
      List<DataPokjabModel> newData = await _fetchDataRekapPieChart();
  ...
  Future<List<DataPokjabModel>> _fetchDataRekapPieChart() async {
    final url = '${baseUrl}data-pokjab-view';
    try {
