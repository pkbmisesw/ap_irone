...
class SuperAdminDataPokjabViewScreen extends StatefulWidget {
  SuperAdminDataPokjabViewScreen({super.key, required this.data});

  final DataPokjabModel data;

  @override
  State<SuperAdminDataPokjabViewScreen> createState() =>
      _SuperAdminDataPokjabViewScreenState();
}

class _SuperAdminDataPokjabViewScreenState
    extends State<SuperAdminDataPokjabViewScreen> {
  final controller = Get.put(SuperAdminDataPokjabServices());
...
class _StepperReview extends StatelessWidget {
  ...
  final controller = Get.find<SuperAdminDataPokjabServices>();
