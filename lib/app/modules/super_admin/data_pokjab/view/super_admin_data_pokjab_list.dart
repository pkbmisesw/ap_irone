...
import 'super_admin_data_pokjab_detail.dart';

class SuperDataPokjabListScreen extends StatefulWidget {
  const SuperDataPokjabListScreen({super.key});

  @override
  State<SuperDataPokjabListScreen> createState() =>
      _SuperDataPokjabListScreenState();
}

class _SuperDataPokjabListScreenState extends State<SuperDataPokjabListScreen> {
  final DataPokjabServicesSuper services = DataPokjabServicesSuper();
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    ...
                                    function1: () {
                                      Get.to(
                                          () => SuperAdminDataPokjabViewScreen(
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            isDeleteAdd: true,
                            function1: () {
                              Get.to(() => SuperAdminDataPokjabViewScreen(
                                    data: data,
                                  ));
                            },
                            function2: () {},
