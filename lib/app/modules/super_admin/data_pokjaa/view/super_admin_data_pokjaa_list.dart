...
import '../controller/super_admin_data_pokjaa_services.dart';
import 'super_admin_data_pokjaa_detail.dart';

class SuperDataPokjaaListScreen extends StatefulWidget {
  const SuperDataPokjaaListScreen({super.key});

  @override
  State<SuperDataPokjaaListScreen> createState() =>
      _SuperDataPokjaaListScreenState();
}

class _SuperDataPokjaaListScreenState extends State<SuperDataPokjaaListScreen> {
  final DataPokjaServicesSuper services = DataPokjaServicesSuper();
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ShowModalBodyListPokja(
                                    ...
                                    function1: () {
                                      Get.to(
                                          () => SuperAdminDataPokjaaViewScreen(
                      ...
                      showModalBottomSheet(
                        ...
                        builder: (context) {
                          return ShowModalBodyListPokja(
                            isDeleteAdd: true,
                            function1: () {
                              Get.to(() => SuperAdminDataPokjaaViewScreen(
                                    data: data,
                                  ));
                            },
                            function2: () {},
