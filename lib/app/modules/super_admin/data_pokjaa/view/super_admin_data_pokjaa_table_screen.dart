...
class SuperAdminTableDataPokjaScreen extends StatefulWidget {
  const SuperAdminTableDataPokjaScreen({super.key});

  @override
  _SuperAdminTableDataPokjaScreenState createState() =>
      _SuperAdminTableDataPokjaScreenState();
}

class _SuperAdminTableDataPokjaScreenState
    extends State<SuperAdminTableDataPokjaScreen> {
  ...
  void getData() async {
    try {
      List<DataPokjaModel> dataRekap =
          await dataServices.fetchTableData('data_pokjaa', withoutID: true);
