...
class DataUmumEditScreen extends StatefulWidget {
  DataUmumEditScreen({super.key, required this.data});

  final DataUmumModel data;

  @override
  State<DataUmumEditScreen> createState() => _DataUmumEditScreenState();
}

class _DataUmumEditScreenState extends State<DataUmumEditScreen> {
  final controller = Get.put(DataUmumServices());
  @override
  void dispose() {
...
class _StepperUmumValue extends StatelessWidget {
  ...
  final controller = Get.find<DataUmumServices>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        WidgetForm(
          hint: controller.editingControllers[2].text,
          value: controller.editingControllers[2].text,
          tittle: 'ID Kelurahan',
