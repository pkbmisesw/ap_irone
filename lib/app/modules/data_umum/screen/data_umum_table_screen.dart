...
class TableDataUmumScreen extends StatefulWidget {
  const TableDataUmumScreen({super.key});

  @override
  _TableDataUmumScreenState createState() => _TableDataUmumScreenState();
}

class _TableDataUmumScreenState extends State<TableDataUmumScreen> {
  ...
  void getData() async {
    try {
      List<DataRekapModels> dataRekap = await dataServices.fetchTableDataUmum();
